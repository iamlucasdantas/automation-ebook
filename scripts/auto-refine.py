...
HAND_CRAFTED = {
    ...
    os.path.join(ROOT, 'acoes-highlevel-cat04.html'),
    os.path.join(ROOT, 'acoes-highlevel-cat05.html'),
    os.path.join(ROOT, 'acoes-highlevel-cat06.html'),
    ...
    os.path.join(ROOT, 'acoes-highlevel-cat11.html'),
